/*
  ...
  strandMeter(range);                 // Lights up a part of the strand given a value between 0 - 255
  colorMap(analog, hueMin, hueMax);   // Changes the hue of the color given a value ranging between 0 - 255. Possible hues are constrained between hueMin/hueMax
  ...
  pot(pin);                           // Returns a value between 0 - 255 of a potentiometer
  lightSensor(pin, min, max)          // Returns a value between 0 - 255 of a light sensor. Can be constrained between min and max
  tempSensor(pin, min, max);          // Returns a value between 0 - 255 of a temperature sensor. Can be constrained between min and max
